...
# ‾‾‾‾‾‾‾‾‾‾‾‾
add-highlighter shared/context/ regex '(\[\w+?=?\w+\])' 1:cyan 2:magenta 3:green
add-highlighter shared/context/ regex '(\[file?:\w+\])' 1:cyan 
...
define-command -hidden context-indent-on-new-line %{
    evaluate-commands -draft -itersel %{
        ...
        try %{ execute-keys -draft Z jxs (\h*\\define\w*[^\[.*\]\n]+)<ret>d<esc>}
