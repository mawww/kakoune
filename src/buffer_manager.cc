...
Buffer* BufferManager::create_buffer(String name, Buffer::Flags flags, ParsedBuffer data)
{
    ...
    m_buffers.push_back(std::make_unique<Buffer>(std::move(name), flags, std::move(data)));
