...
Some keys cannot be mapped directly but they can still mapped by using an alias.

Here some of the keys that may be maped this way followed by one or more aliases:
