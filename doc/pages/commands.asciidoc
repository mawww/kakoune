...
*quit-all[!]* [<exit status>]::
    *alias* qa +
    exit Kakoune and close all the open clients, use quit-all! to
    force quitting even if there is some unsaved buffer remaining.
    If specified, the clients exit status will be set to <exit status>
