 ...
 * `set-color-scheme <name>`: load named color scheme.
...
`../share/kak/color-schemes/`. If `$XDG_CONFIG_HOME/kak/color-schemes/` is present
the builtin command `set-color-scheme` will offer completion for those
