 ...
 * `kak_window_top`: top offset of the current kakoune window
 * `kak_window_left`: left offset of the current kakoune window
 * `kak_window_range_column`: width (without line numbers) of the current kakoune window
 * `kak_window_range_line`: height (without line numbers) of the current kakoune window
